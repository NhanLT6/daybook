...
- **Sticky Notes**: Card-based rich-text notes tab with pin (pinned-first), colors, search, drag reorder / drag-to-trash (mouse + touch); Chat reads notes via the client-side `searchNotes` tool (see `docs/features/notes.md`)
